...
// ─────────────────────────────────────────────────────────────────────────────
const SEED_WORDS = [
  {word:"Fire",categories:["Science","History"],eras:["Prehistoric","All Time"],difficulty:"Easy"},
  {word:"The Wheel",categories:["Science","History"],eras:["Prehistoric","All Time"],difficulty:"Easy"},
  {word:"Cave Paintings",categories:["Art","History"],eras:["Prehistoric"],difficulty:"Medium"},
  {word:"Stone Tools",categories:["Science","History"],eras:["Prehistoric"],difficulty:"Easy"},
  {word:"Woolly Mammoth",categories:["Science","History"],eras:["Prehistoric"],difficulty:"Easy"},
  {word:"Stonehenge",categories:["History","Architecture"],eras:["Prehistoric","All Time"],difficulty:"Medium"},
  {word:"Agriculture",categories:["Science","History"],eras:["Prehistoric","All Time"],difficulty:"Medium"},
  {word:"Homo Sapiens",categories:["Science","History"],eras:["Prehistoric","All Time"],difficulty:"Medium"},
  {word:"Neanderthal",categories:["Science","History"],eras:["Prehistoric"],difficulty:"Medium"},
  {word:"Domestication of Animals",categories:["Science","History"],eras:["Prehistoric"],difficulty:"Hard"},
  {word:"Lascaux Cave",categories:["Art","History"],eras:["Prehistoric"],difficulty:"Hard"},
  {word:"Hunter-Gatherers",categories:["History"],eras:["Prehistoric"],difficulty:"Easy"},
  {word:"Ice Age",categories:["Science","History"],eras:["Prehistoric","All Time"],difficulty:"Easy"},
  {word:"Burial Mounds",categories:["History","Architecture"],eras:["Prehistoric"],difficulty:"Hard"},
  {word:"The Pyramids",categories:["Architecture","History"],eras:["Ancient Civilizations","All Time"],difficulty:"Easy"},
  {word:"Cleopatra",categories:["History","Politics"],eras:["Ancient Civilizations","All Time"],difficulty:"Easy"},
  {word:"Hieroglyphics",categories:["History","Literature"],eras:["Ancient Civilizations"],difficulty:"Easy"},
  {word:"The Nile River",categories:["Geography","History"],eras:["Ancient Civilizations","All Time"],difficulty:"Easy"},
  {word:"Pharaoh",categories:["History","Politics"],eras:["Ancient Civilizations"],difficulty:"Easy"},
  {word:"Mesopotamia",categories:["History","Geography"],eras:["Ancient Civilizations"],difficulty:"Medium"},
  {word:"Hammurabi's Code",categories:["History","Politics"],eras:["Ancient Civilizations"],difficulty:"Hard"},
  {word:"Cuneiform Writing",categories:["History","Literature"],eras:["Ancient Civilizations"],difficulty:"Hard"},
  {word:"Babylon",categories:["History","Geography"],eras:["Ancient Civilizations"],difficulty:"Medium"},
  {word:"The Sphinx",categories:["Architecture","History"],eras:["Ancient Civilizations","All Time"],difficulty:"Easy"},
  {word:"Mummification",categories:["History","Science"],eras:["Ancient Civilizations"],difficulty:"Medium"},
  {word:"The Great Wall of China",categories:["Architecture","History"],eras:["Ancient Civilizations","All Time"],difficulty:"Easy"},
  {word:"Confucius",categories:["History","Philosophy"],eras:["Ancient Civilizations","All Time"],difficulty:"Medium"},
  {word:"Sun Tzu",categories:["History","Literature"],eras:["Ancient Civilizations","All Time"],difficulty:"Medium"},
  {word:"The Hanging Gardens of Babylon",categories:["Architecture","History"],eras:["Ancient Civilizations"],difficulty:"Medium"},
  {word:"Tutankhamun",categories:["History"],eras:["Ancient Civilizations","All Time"],difficulty:"Medium"},
  {word:"The Rosetta Stone",categories:["History","Literature"],eras:["Ancient Civilizations","All Time"],difficulty:"Medium"},
  {word:"Ramesses II",categories:["History","Politics"],eras:["Ancient Civilizations"],difficulty:"Hard"},
  {word:"The Ziggurat",categories:["Architecture","History"],eras:["Ancient Civilizations"],difficulty:"Hard"},
  {word:"Phoenician Alphabet",categories:["History","Literature"],eras:["Ancient Civilizations"],difficulty:"Hard"},
  {word:"Socrates",categories:["Philosophy","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Plato",categories:["Philosophy","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Aristotle",categories:["Philosophy","Science"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Alexander the Great",categories:["History","Politics"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"Julius Caesar",categories:["History","Politics"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"The Colosseum",categories:["Architecture","History","Sports"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"Democracy",categories:["Politics","History"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"The Olympics",categories:["Sports","History"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"Homer",categories:["Literature","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"The Iliad",categories:["Literature","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"The Odyssey",categories:["Literature","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Archimedes",categories:["Science","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Pythagoras",categories:["Science","Math"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"The Roman Senate",categories:["Politics","History"],eras:["Classical Antiquity","All Time"],difficulty:"Easy"},
  {word:"Gladiators",categories:["Sports","History"],eras:["Classical Antiquity"],difficulty:"Easy"},
  {word:"Spartacus",categories:["History","Sports"],eras:["Classical Antiquity"],difficulty:"Medium"},
  {word:"Hippocrates",categories:["Science","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"The Battle of Thermopylae",categories:["History","Sports"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"Hannibal Barca",categories:["History","Politics"],eras:["Classical Antiquity"],difficulty:"Medium"},
  {word:"Marcus Aurelius",categories:["History","Philosophy"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"The Acropolis",categories:["Architecture","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Euclid",categories:["Science","Math"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"Cicero",categories:["History","Politics","Literature"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"The Trojan War",categories:["History","Literature"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"The Parthenon",categories:["Architecture","History"],eras:["Classical Antiquity","All Time"],difficulty:"Medium"},
  {word:"Herodotus",categories:["History","Literature"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"Pericles",categories:["History","Politics"],eras:["Classical Antiquity"],difficulty:"Hard"},
  {word:"The Fall of Rome",categories:["History","Politics"],eras:["Late Antiquity"],difficulty:"Medium"},
  {word:"Constantine the Great",categories:["History","Politics"],eras:["Late Antiquity"],difficulty:"Medium"},
  {word:"Saint Augustine",categories:["History","Philosophy"],eras:["Late Antiquity"],difficulty:"Hard"},
  {word:"The Byzantine Empire",categories:["History","Politics"],eras:["Late Antiquity"],difficulty:"Hard"},
  {word:"Attila the Hun",categories:["History"],eras:["Late Antiquity"],difficulty:"Medium"},
  {word:"The Silk Road",categories:["History","Geography","Finance"],eras:["Late Antiquity","Medieval Period","All Time"],difficulty:"Medium"},
  {word:"The Rise of Christianity",categories:["History","Philosophy"],eras:["Late Antiquity","All Time"],difficulty:"Easy"},
  {word:"Justinian I",categories:["History","Politics"],eras:["Late Antiquity"],difficulty:"Hard"},
  {word:"The Visigoths",categories:["History"],eras:["Late Antiquity"],difficulty:"Hard"},
  {word:"Hypatia of Alexandria",categories:["Science","History","Philosophy"],eras:["Late Antiquity"],difficulty:"Hard"},
  {word:"The Black Death",categories:["History","Science"],eras:["Medieval Period"],difficulty:"Easy"},
  {word:"Magna Carta",categories:["History","Politics"],eras:["Medieval Period","All Time"],difficulty:"Medium"},
  {word:"Charlemagne",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"The Crusades",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Easy"},
  {word:"Joan of Arc",categories:["History"],eras:["Medieval Period","All Time"],difficulty:"Easy"},
  {word:"Feudalism",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"Genghis Khan",categories:["History","Politics"],eras:["Medieval Period","All Time"],difficulty:"Easy"},
  {word:"Notre Dame Cathedral",categories:["Architecture","History"],eras:["Medieval Period","All Time"],difficulty:"Easy"},
  {word:"The Vikings",categories:["History"],eras:["Medieval Period"],difficulty:"Easy"},
  {word:"Marco Polo",categories:["History","Geography"],eras:["Medieval Period","All Time"],difficulty:"Medium"},
  {word:"Dante Alighieri",categories:["Literature","History"],eras:["Medieval Period","All Time"],difficulty:"Medium"},
  {word:"The Canterbury Tales",categories:["Literature"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"Alchemy",categories:["Science","History"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"The Trebuchet",categories:["History","Science"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"Robin Hood",categories:["History","Literature"],eras:["Medieval Period","All Time"],difficulty:"Easy"},
  {word:"Chivalry",categories:["History","Literature"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"Saladin",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Hard"},
  {word:"Thomas Aquinas",categories:["Philosophy","History"],eras:["Medieval Period"],difficulty:"Hard"},
  {word:"The Hundred Years War",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Hard"},
  {word:"William the Conqueror",categories:["History","Politics"],eras:["Medieval Period"],difficulty:"Medium"},
  {word:"Chaucer",categories:["Literature","History"],eras:["Medieval Period"],difficulty:"Hard"},
  {word:"Leonardo da Vinci",categories:["Art","Science","History"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"Michelangelo",categories:["Art","History"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"The Sistine Chapel",categories:["Art","Architecture"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"The Mona Lisa",categories:["Art"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"The Gutenberg Press",categories:["History","Technology"],eras:["The Renaissance","All Time"],difficulty:"Medium"},
  {word:"Machiavelli",categories:["History","Politics","Literature"],eras:["The Renaissance","All Time"],difficulty:"Medium"},
  {word:"William Shakespeare",categories:["Literature","History"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"Galileo Galilei",categories:["Science","History"],eras:["The Renaissance","All Time"],difficulty:"Easy"},
  {word:"Copernicus",categories:["Science","History"],eras:["The Renaissance"],difficulty:"Medium"},
  {word:"The Medici Family",categories:["History","Finance","Politics"],eras:["The Renaissance"],difficulty:"Medium"},
  {word:"Botticelli",categories:["Art","History"],eras:["The Renaissance"],difficulty:"Hard"},
  {word:"Raphael",categories:["Art","History"],eras:["The Renaissance"],difficulty:"Medium"},
  {word:"Donatello",categories:["Art","History"],eras:["The Renaissance"],difficulty:"Medium"},
  {word:"Humanism",categories:["Philosophy","History"],eras:["The Renaissance"],difficulty:"Hard"},
  {word:"The Vitruvian Man",categories:["Art","Science"],eras:["The Renaissance","All Time"],difficulty:"Medium"},
  {word:"The Protestant Reformation",categories:["History","Politics"],eras:["The Renaissance"],difficulty:"Medium"},
  {word:"Martin Luther",categories:["History","Politics"],eras:["The Renaissance","All Time"],difficulty:"Medium"},
  {word:"Christopher Columbus",categories:["History","Geography"],eras:["Age of Exploration","All Time"],difficulty:"Easy"},
  {word:"Ferdinand Magellan",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Medium"},
  {word:"Vasco da Gama",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Hard"},
  {word:"The Aztec Empire",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Easy"},
  {word:"The Inca Empire",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Easy"},
  {word:"Conquistadors",categories:["History"],eras:["Age of Exploration"],difficulty:"Medium"},
  {word:"The Spice Trade",categories:["History","Finance"],eras:["Age of Exploration"],difficulty:"Medium"},
  {word:"Amerigo Vespucci",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Hard"},
  {word:"The Compass",categories:["Science","History"],eras:["Age of Exploration","All Time"],difficulty:"Easy"},
  {word:"Colonialism",categories:["History","Politics"],eras:["Age of Exploration","All Time"],difficulty:"Medium"},
  {word:"Sir Francis Drake",categories:["History","Geography"],eras:["Age of Exploration"],difficulty:"Hard"},
  {word:"Hernan Cortes",categories:["History","Politics"],eras:["Age of Exploration"],difficulty:"Medium"},
  {word:"The Mayflower",categories:["History"],eras:["Age of Exploration"],difficulty:"Easy"},
  {word:"Isaac Newton",categories:["Science","History"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"Gravity",categories:["Science"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"John Locke",categories:["Philosophy","History","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Medium"},
  {word:"Voltaire",categories:["Philosophy","Literature","History"],eras:["The Enlightenment"],difficulty:"Medium"},
  {word:"Jean-Jacques Rousseau",categories:["Philosophy","History"],eras:["The Enlightenment"],difficulty:"Medium"},
  {word:"Benjamin Franklin",categories:["History","Science","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"The French Revolution",categories:["History","Politics"],eras:["The Enlightenment"],difficulty:"Easy"},
  {word:"The American Revolution",categories:["History","Politics"],eras:["The Enlightenment"],difficulty:"Easy"},
  {word:"Adam Smith",categories:["Finance","History","Philosophy"],eras:["The Enlightenment","All Time"],difficulty:"Medium"},
  {word:"Immanuel Kant",categories:["Philosophy","History"],eras:["The Enlightenment"],difficulty:"Hard"},
  {word:"Thomas Jefferson",categories:["History","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"Napoleon Bonaparte",categories:["History","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"The Declaration of Independence",categories:["History","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"The Guillotine",categories:["History"],eras:["The Enlightenment"],difficulty:"Easy"},
  {word:"Marie Antoinette",categories:["History","Fashion"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"Robespierre",categories:["History","Politics"],eras:["The Enlightenment"],difficulty:"Hard"},
  {word:"The Bastille",categories:["History","Politics"],eras:["The Enlightenment"],difficulty:"Medium"},
  {word:"George Washington",categories:["History","Politics"],eras:["The Enlightenment","All Time"],difficulty:"Easy"},
  {word:"The Boston Tea Party",categories:["History","Politics"],eras:["The Enlightenment"],difficulty:"Easy"},
  {word:"Montesquieu",categories:["Philosophy","Politics","History"],eras:["The Enlightenment"],difficulty:"Hard"},
  {word:"David Hume",categories:["Philosophy","History"],eras:["The Enlightenment"],difficulty:"Hard"},
  {word:"The Steam Engine",categories:["Science","Technology","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Charles Darwin",categories:["Science","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Evolution",categories:["Science"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Karl Marx",categories:["History","Politics","Philosophy"],eras:["Industrial Revolution","All Time"],difficulty:"Medium"},
  {word:"The Railroad",categories:["History","Technology"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Thomas Edison",categories:["Science","Technology","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Electricity",categories:["Science","Technology"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Nikola Tesla",categories:["Science","Technology","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"The Telephone",categories:["Technology","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Abraham Lincoln",categories:["History","Politics"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"The American Civil War",categories:["History","Politics"],eras:["Industrial Revolution"],difficulty:"Easy"},
  {word:"Florence Nightingale",categories:["History","Science"],eras:["Industrial Revolution","All Time"],difficulty:"Medium"},
  {word:"The Eiffel Tower",categories:["Architecture","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Sigmund Freud",categories:["Science","History"],eras:["Industrial Revolution","All Time"],difficulty:"Medium"},
  {word:"Charles Dickens",categories:["Literature","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Marie Curie",categories:["Science","History"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"Child Labor",categories:["History","Politics"],eras:["Industrial Revolution"],difficulty:"Medium"},
  {word:"The Suez Canal",categories:["History","Geography"],eras:["Industrial Revolution","All Time"],difficulty:"Medium"},
  {word:"Queen Victoria",categories:["History","Politics"],eras:["Industrial Revolution","All Time"],difficulty:"Easy"},
  {word:"The Emancipation Proclamation",categories:["History","Politics"],eras:["Industrial Revolution"],difficulty:"Medium"},
  {word:"Samuel Morse",categories:["Technology","History"],eras:["Industrial Revolution"],difficulty:"Medium"},
  {word:"The Luddites",categories:["History","Politics"],eras:["Industrial Revolution"],difficulty:"Hard"},
  {word:"James Watt",categories:["Science","Technology","History"],eras:["Industrial Revolution"],difficulty:"Hard"},
  {word:"World War I",categories:["History","Politics"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"World War II",categories:["History","Politics"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Albert Einstein",categories:["Science","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Theory of Relativity",categories:["Science"],eras:["Modern Era","All Time"],difficulty:"Medium"},
  {word:"The Great Depression",categories:["Finance","History"],eras:["Modern Era"],difficulty:"Easy"},
  {word:"The Holocaust",categories:["History","Politics"],eras:["Modern Era"],difficulty:"Easy"},
  {word:"Winston Churchill",categories:["History","Politics"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Franklin D. Roosevelt",categories:["History","Politics"],eras:["Modern Era"],difficulty:"Easy"},
  {word:"The Manhattan Project",categories:["Science","History","Politics"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"Jazz Music",categories:["Music","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Charlie Chaplin",categories:["Film & TV","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Wright Brothers",categories:["Science","Technology","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Babe Ruth",categories:["Sports","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Prohibition",categories:["History","Politics"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"Mahatma Gandhi",categories:["History","Politics"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Stock Market Crash of 1929",categories:["Finance","History"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"Amelia Earhart",categories:["History","Technology"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"Pablo Picasso",categories:["Art","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Harlem Renaissance",categories:["Art","Music","History"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"Coco Chanel",categories:["Fashion","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Treaty of Versailles",categories:["History","Politics"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"Ernest Hemingway",categories:["Literature","History"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Titanic",categories:["History","Technology"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The New Deal",categories:["History","Politics","Finance"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"D-Day",categories:["History","Politics"],eras:["Modern Era"],difficulty:"Easy"},
  {word:"The Atomic Bomb",categories:["Science","History","Politics"],eras:["Modern Era","All Time"],difficulty:"Easy"},
  {word:"The Roaring Twenties",categories:["History","Finance","Music"],eras:["Modern Era"],difficulty:"Medium"},
  {word:"The Moon Landing",categories:["Science","Technology","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The Cold War",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Easy"},
  {word:"Martin Luther King Jr.",categories:["History","Politics"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Elvis Presley",categories:["Music","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The Beatles",categories:["Music","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Muhammad Ali",categories:["Sports","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Marilyn Monroe",categories:["Film & TV","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The JFK Assassination",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Easy"},
  {word:"Woodstock Festival",categories:["Music","History"],eras:["Postwar Era"],difficulty:"Easy"},
  {word:"The Vietnam War",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Easy"},
  {word:"The Berlin Wall",categories:["History","Politics"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Watergate",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Medium"},
  {word:"Bob Dylan",categories:["Music","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The Civil Rights Movement",categories:["History","Politics"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Pele",categories:["Sports"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The Rolling Stones",categories:["Music"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Jimi Hendrix",categories:["Music"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Sputnik",categories:["Science","Technology","History"],eras:["Postwar Era"],difficulty:"Medium"},
  {word:"Audrey Hepburn",categories:["Film & TV","Fashion"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Neil Armstrong",categories:["Science","Technology","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Rosa Parks",categories:["History","Politics"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"Andy Warhol",categories:["Art","Fashion","History"],eras:["Postwar Era","All Time"],difficulty:"Easy"},
  {word:"The Cuban Missile Crisis",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Medium"},
  {word:"Che Guevara",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Medium"},
  {word:"The Space Race",categories:["Science","Technology","History"],eras:["Postwar Era"],difficulty:"Easy"},
  {word:"Malcolm X",categories:["History","Politics"],eras:["Postwar Era","All Time"],difficulty:"Medium"},
  {word:"The Stonewall Riots",categories:["History","Politics"],eras:["Postwar Era"],difficulty:"Hard"},
  {word:"Alfred Hitchcock",categories:["Film & TV"],eras:["Postwar Era","All Time"],difficulty:"Medium"},
  {word:"The Summer of Love",categories:["History","Music"],eras:["Postwar Era"],difficulty:"Medium"},
  {word:"The Internet",categories:["Technology","History"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Steve Jobs",categories:["Technology","Finance","History"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Michael Jordan",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Michael Jackson",categories:["Music"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"The Fall of the Berlin Wall",categories:["History","Politics"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"9/11",categories:["History","Politics"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Social Media",categories:["Technology"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Climate Change",categories:["Science","Politics"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Bitcoin",categories:["Finance","Technology"],eras:["Digital Age"],difficulty:"Medium"},
  {word:"Elon Musk",categories:["Technology","Finance"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Harry Potter",categories:["Literature","Film & TV"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Tiger Woods",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Serena Williams",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Taylor Swift",categories:["Music"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Artificial Intelligence",categories:["Technology","Science"],eras:["Digital Age","All Time"],difficulty:"Medium"},
  {word:"The Smartphone",categories:["Technology"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Jeff Bezos",categories:["Finance","Technology"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Barack Obama",categories:["Politics","History"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Netflix",categories:["Film & TV","Technology","Finance"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"LeBron James",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Mark Zuckerberg",categories:["Technology","Finance"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"COVID-19 Pandemic",categories:["Science","History","Politics"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"SpaceX",categories:["Science","Technology"],eras:["Digital Age"],difficulty:"Medium"},
  {word:"Cryptocurrency",categories:["Finance","Technology"],eras:["Digital Age"],difficulty:"Medium"},
  {word:"Usain Bolt",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"Game of Thrones",categories:["Film & TV","Literature"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Kanye West",categories:["Music","Fashion"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"The iPhone",categories:["Technology"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Wikipedia",categories:["Technology","Literature"],eras:["Digital Age"],difficulty:"Easy"},
  {word:"Genome Sequencing",categories:["Science"],eras:["Digital Age"],difficulty:"Hard"},
  {word:"Roger Federer",categories:["Sports"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"The Arab Spring",categories:["History","Politics"],eras:["Digital Age"],difficulty:"Hard"},
  {word:"Nelson Mandela",categories:["History","Politics"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"The Housing Crisis of 2008",categories:["Finance","History"],eras:["Digital Age"],difficulty:"Medium"},
  {word:"Oprah Winfrey",categories:["Film & TV","Finance"],eras:["Digital Age","All Time"],difficulty:"Easy"},
  {word:"CRISPR",categories:["Science"],eras:["Digital Age"],difficulty:"Expert"},
  {word:"The Iraq War",categories:["History","Politics"],eras:["Digital Age"],difficulty:"Medium"},
  {word:"Money",categories:["Finance"],eras:["All Time"],difficulty:"Easy"},
  {word:"War",categories:["History","Politics"],eras:["All Time"],difficulty:"Easy"},
  {word:"Religion",categories:["History","Philosophy"],eras:["All Time"],difficulty:"Easy"},
  {word:"Language",categories:["History","Literature"],eras:["All Time"],difficulty:"Medium"},
  {word:"Mathematics",categories:["Science","Math"],eras:["All Time"],difficulty:"Easy"},
  {word:"Gold",categories:["Finance","History"],eras:["All Time"],difficulty:"Easy"},
  {word:"The Ocean",categories:["Science","Geography"],eras:["All Time"],difficulty:"Easy"},
  {word:"The Sun",categories:["Science"],eras:["All Time"],difficulty:"Easy"},
  {word:"Music",categories:["Music"],eras:["All Time"],difficulty:"Easy"},
  {word:"Revolution",categories:["History","Politics"],eras:["All Time"],difficulty:"Medium"},
  {word:"Trade",categories:["Finance","History"],eras:["All Time"],difficulty:"Medium"},
  {word:"Power",categories:["Politics","History"],eras:["All Time"],difficulty:"Medium"},
  {word:"The Written Word",categories:["Literature","History"],eras:["All Time"],difficulty:"Medium"},
  {word:"Plague",categories:["Science","History"],eras:["All Time"],difficulty:"Easy"},
  {word:"The Printing Press",categories:["Technology","History"],eras:["All Time"],difficulty:"Easy"},
  {word:"Taxes",categories:["Finance","Politics"],eras:["All Time"],difficulty:"Easy"},
  {word:"Slavery",categories:["History","Politics"],eras:["All Time"],difficulty:"Easy"},
...
// ─────────────────────────────────────────────────────────────────────────────
// DAILY DECK — deterministic by date
// ─────────────────────────────────────────────────────────────────────────────
...
async function fetchBooWords(word, categories, eras, difficulty) {
  const cached = await getCachedBooWords(word);
  ...
  const res = await fetch("/api/anthropic", {
    ...
    body: JSON.stringify({
      ...
      messages: [{
        role: "user",
        content: `BOOHist word game. Generate 6 forbidden BOOwords for: "${word}"\nCategory: ${categories.join(", ")} | Era: ${eras.join(", ")} | Difficulty: ${difficulty}\nChoose the 6 words a player would most naturally use to describe "${word}". No part of the target word.\nRespond ONLY with a JSON array of 6 strings. No markdown, no explanation.`,
      }],
    }),
  });
...
export default function BooHist() {
  ...
  const buildDeck = useCallback(async (seedWords, gameMode) => {
    ...
    for(let i=0;i<seedWords.length;i++){
      ...
      try { const booWords = await fetchBooWords(w.word,w.categories,w.eras,w.difficulty); built.push({...w,booWords}); }
        ...
        {screen==="game" && card && (
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", width:"100%", animation:"fadeUp 0.3s ease" }}>
            ...
            {!started ? (
              ...
              <DailyCard card={card} choices={choices} onPick={handlePick} onHint={handleDailyHint} timerPct={timerPct} urgent={urgent} cardNum={cardIdx+1} total={deck.length} hintEliminatedIdx={hintEliminatedIdx} flashWrong={flashWrong} />
            ) : (
